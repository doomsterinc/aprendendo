...
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* MainView__Fuse_Controls_Shape_Fuse_Drawing_Brush_Fill_Property_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* MainView__Fuse_Reactive_Each_object_Items_Property_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::MainView__Fuse_Controls_Shape_Fuse_Drawing_Brush_Fill_Property_typeof,
        (uType*(*)())&::g::MainView__Fuse_Controls_TextControl_string_Value_Property_typeof,
        (uType*(*)())&::g::MainView__Fuse_Reactive_Each_object_Items_Property_typeof,
