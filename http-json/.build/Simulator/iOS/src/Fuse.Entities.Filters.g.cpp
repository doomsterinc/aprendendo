...
// /usr/local/share/uno/Packages/Fuse.Entities/0.18.8/Filters/$.uno(123)
// ---------------------------------------------------------------------
...
uType* Blitter_typeof()
{
    ...
    ::TYPES[3] = ::g::Fuse_Effects_bundle_typeof();
    type->SetFields(0,
...
void Blitter::init_DrawCalls()
{
    ...
    _draw_5f2d2bfe = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Effects_bundle::EffectHelpers19f0dc38());
}
...
// /usr/local/share/uno/Packages/Fuse.Entities/0.18.8/Filters/$.uno(12)
// --------------------------------------------------------------------
...
::g::Fuse::Entities::RenderNode_type* Blur_typeof()
{
    ...
    ::TYPES[1] = ::g::Uno::UShort_typeof()->Array();
    ::TYPES[2] = ::g::Uno::Float2_typeof()->Array();
    ::TYPES[8] = ::g::Fuse_Entities_bundle_typeof();
...
void Blur::init_DrawCalls()
{
    ...
    _draw_cd9d8ce5 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Entities_bundle::Blur17c40e2b());
}
...
// /usr/local/share/uno/Packages/Fuse.Entities/0.18.8/Filters/$.uno(156)
// ---------------------------------------------------------------------
...
void FindEdges::init_DrawCalls()
{
    ...
    _draw_fe86b546 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Entities_bundle::FindEdges6e47be68());
}
