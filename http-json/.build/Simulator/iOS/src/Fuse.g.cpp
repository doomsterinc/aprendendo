...
static uType* TYPES[171];

namespace g{
namespace Fuse{

// /usr/local/share/uno/Packages/Fuse.iOS/0.18.8/$.uno(257)
// --------------------------------------------------------

// public extern class App :257
// {
...
// protected override sealed void OnSetRootNode(Fuse.Node root) :308
...
// protected override sealed void OnSetTheme(Fuse.Theme theme) :318
...
// private void OnTick(object sender, Uno.Platform.TimerEventArgs args) :277
void App__OnTick_fn(App* __this, uObject* sender, ::g::Uno::Platform::TimerEventArgs* args)
{
    __this->OnTick(sender, args);
}

// protected override void OnUpdate() :346
...
// private void CheckFocus() [instance] :354
void App::CheckFocus()
{
    if (::g::ObjC::ID::op_Equality(::g::ObjC::Object::op_Implicit(_currentFocus), ::g::ObjC::Object::op_Implicit(NULL)) || !uPtr(_currentFocus)->isFirstResponder())
    {
        ::g::iOS::UIKit::UIView* uiview = ::g::Fuse::iOS::FirstResponder::Current();

        if (!(::g::ObjC::ID::op_Equality(::g::ObjC::Object::op_Implicit(_currentFocus), ::g::ObjC::Object::op_Implicit(NULL)) && ::g::ObjC::ID::op_Equality(::g::ObjC::Object::op_Implicit(uiview), ::g::ObjC::Object::op_Implicit(NULL))))
        {
            ::g::Fuse::Node* node = ::g::ObjC::ID::op_Equality(::g::ObjC::Object::op_Implicit(uiview), ::g::ObjC::Object::op_Implicit(NULL)) ? uCast< ::g::Fuse::Node*>(NULL, ::TYPES[3/*Fuse.Node*/]) : (::g::Fuse::Node*)::g::Fuse::iOS::NativeViews::NativeView::GetFrom1(uiview);
...
// private void OnTick(object sender, Uno.Platform.TimerEventArgs args) [instance] :277
...
// private void PropagateBackground() [instance] :302
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(30)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(3875)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(3910)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(230)
// --------------------------------------------------------
...
Behavior_type* Behavior_typeof()
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno");
...
void Behavior::Rooted(::g::Fuse::Node* e)
{
    if (_status != 0)
    {
        ::g::Fuse::Diagnostics::Error(::STRINGS[3/*"duplicate b...*/], this, ::STRINGS[4/*"/usr/local/...*/], 250, ::STRINGS[5/*"Rooted"*/]);
        return;
    }
...
void Behavior::Unrooted(::g::Fuse::Node* e)
{
    if (_status == 0)
    {
        ::g::Fuse::Diagnostics::Error(::STRINGS[6/*"duplicate b...*/], this, ::STRINGS[4/*"/usr/local/...*/], 264, ::STRINGS[7/*"Unrooted"*/]);
        return;
    }
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(289)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5931)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2167)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2181)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(409)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1674)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(479)
// --------------------------------------------------------
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[4/*"/usr/local/...*/], 554, ::STRINGS[13/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[4/*"/usr/local/...*/], 681, ::STRINGS[15/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[4/*"/usr/local/...*/], 611, ::STRINGS[26/*"set_GLFrame...*/]);
}

// private void GLInconsistent(string msg) [instance] :821
void DrawContext::GLInconsistent(uString* msg)
{
    ::g::Fuse::Diagnostics::Error(::g::Uno::String::op_Addition2(::STRINGS[16/*"Inconsisten...*/], msg), this, ::STRINGS[4/*"/usr/local/...*/], 823, ::STRINGS[17/*"GLInconsist...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[4/*"/usr/local/...*/], 722, ::STRINGS[29/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[4/*"/usr/local/...*/], 766, ::STRINGS[31/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[4/*"/usr/local/...*/], 655, ::STRINGS[18/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[4/*"/usr/local/...*/], 640, ::STRINGS[19/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[20/*"Unpopped Sc...*/], this, ::STRINGS[4/*"/usr/local/...*/], 571, ::STRINGS[21/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[22/*"Unpopped Cu...*/], this, ::STRINGS[4/*"/usr/local/...*/], 575, ::STRINGS[21/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[23/*"Unpopped Vi...*/], this, ::STRINGS[4/*"/usr/local/...*/], 579, ::STRINGS[21/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[24/*"Unpopped Re...*/], this, ::STRINGS[4/*"/usr/local/...*/], 583, ::STRINGS[21/*"ReleaseRoot...*/]);
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1684)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2235)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1009)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1964)
// ---------------------------------------------------------
...
{
    return ::g::Fuse::IFrustum::GetWorldPosition(uInterface(uPtr(_frustum), ::TYPES[140/*Fuse.IFrustum*/]), (uObject*)this);
}
...
{
    return ::g::Fuse::IFrustum::GetDepthRange(uInterface(uPtr(_frustum), ::TYPES[140/*Fuse.IFrustum*/]), (uObject*)this);
}
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1234)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1211)
// ---------------------------------------------------------
...
::g::Fuse::Font* Fonts::Fallback()
{
    if (Fonts::_fallback() == NULL)
        Fonts::_fallback() = ::g::Fuse::Font::New1(::g::Uno::UX::BundleFileSource::New1(::g::FuseCore_bundle::OpenSans_Light34a53346()));

    return Fonts::_fallback();
}
// }

// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1299)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1344)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1922)
// ---------------------------------------------------------
...
{
    ProjectionTransform = ::g::Fuse::IFrustum::GetProjectionTransform(uInterface(uPtr(frustum), ::TYPES[140/*Fuse.IFrustum*/]), viewport);
    ProjectionTransformInverse = ::g::Fuse::IFrustum::GetProjectionTransformInverse(uInterface(frustum, ::TYPES[140/*Fuse.IFrustum*/]), viewport);
    ViewTransform = ::g::Fuse::IFrustum::GetViewTransform(uInterface(frustum, ::TYPES[140/*Fuse.IFrustum*/]), viewport);
    ViewTransformInverse = ::g::Fuse::IFrustum::GetViewTransformInverse(uInterface(frustum, ::TYPES[140/*Fuse.IFrustum*/]), viewport);
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5882)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(4434)
// ---------------------------------------------------------
...
{
    GraphicsWorker::_work_ = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[76/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
}
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1562)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1572)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1686)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2508)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1565)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6303)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5262)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(457)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1655)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2785)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Entities/0.18.8/Processing/$.uno(17)
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5255)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6324)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6329)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1899)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1703)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Launcher/0.18.8/$.uno(20)
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2758)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2793)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2765)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6336)
// ---------------------------------------------------------
...
TranslationModes__LocalMode_type* TranslationModes__LocalMode_typeof()
{
    ...
    ::TYPES[85] = ::g::Fuse::Translation_typeof();
    type->SetInterfaces(
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2805)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2016)
// ---------------------------------------------------------
...
uType* MobileBootstrapping_typeof()
{
    ...
    ::TYPES[15] = ::g::Uno::Platform2::ApplicationStateTransitionHandler_typeof();
    ::TYPES[16] = ::g::Uno::EventHandler_typeof();
    ::TYPES[86] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof());
    ::TYPES[4] = ::g::Uno::Platform2::Display_typeof();
    ::TYPES[2] = ::g::Uno::Application_typeof();
    ::TYPES[87] = ::g::Uno::EventArgs_typeof();
    type->SetFields(0,
...
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[86/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[86/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[86/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[86/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyReleased_fn));
}
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5897)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5912)
// ---------------------------------------------------------
...
uType* NativeWithFallbackTheme_typeof()
{
    ...
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    ::TYPES[75] = ::g::Fuse::Theme_typeof();
    ::TYPES[88] = NativeWithFallbackTheme__CreateTheme_typeof();
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2099)
// ---------------------------------------------------------
...
static void Node__cctor__fn(uType* __type)
{
    ...
    Node::NameProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[89/*Fuse.StyleProperty<Fuse.Node, string>*/], NULL, uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Node>*/], (void*)Node__OnNameChanged_fn), &ret6), ret6);
    Node::_isEnabledChangedHandle_ = ::g::Fuse::Properties::CreateHandle();
    Node::IsEnabledProperty_ = (::g::Fuse::StyleProperty1__New2_fn(::TYPES[90/*Fuse.StyleProperty<Fuse.Node, bool>*/], uCRef(true), uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Node>*/], (void*)Node__OnIsEnabledChangedInternal_fn), NULL, NULL, &ret7), ret7);
    ...
    Node::SnapToPixelsProperty_ = (::g::Fuse::StyleProperty1__New1_fn(::TYPES[90/*Fuse.StyleProperty<Fuse.Node, bool>*/], uCRef(true), uDelegate::New(::TYPES[21/*Uno.Action<Fuse.Node>*/], (void*)Node__InvalidateLayout1_fn), &ret8), ret8);
...
Node_type* Node_typeof()
{
    ...
    ::STRINGS[14] = uString::Const("");
    ::TYPES[89] = ::g::Fuse::StyleProperty1_typeof()->MakeType(Node_typeof(), ::g::Uno::String_typeof());
    ...
    ::TYPES[57] = ::g::Uno::Float_typeof();
    ::TYPES[100] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof());
    ::TYPES[101] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[102] = ::g::Fuse::Scripting::INameScope_typeof();
    ::TYPES[78] = ::g::Fuse::HitTestCallback_typeof();
    ::TYPES[103] = Node__HitTestRecord_typeof();
    ::TYPES[104] = ::g::Fuse::PropertyState_typeof();
    ::TYPES[105] = ::g::Uno::Collections::HashSet_typeof()->MakeType(Node_typeof());
    ::TYPES[106] = ::g::Fuse::HitTestContext_typeof();
    ::TYPES[107] = ::g::Uno::Float3_typeof();
    ::TYPES[74] = ::g::Uno::Geometry::Ray_typeof();
    ::TYPES[108] = ::g::Fuse::UpdateManager_typeof();
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    ::TYPES[109] = ::g::Fuse::BeginRemoveHandler_typeof();
    ::TYPES[110] = ::g::Fuse::RequestBringIntoViewHandler_typeof();
    ::TYPES[111] = ::g::Fuse::DataContextChangedHandler_typeof();
    ::TYPES[112] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[113] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[114] = ::g::Uno::UX::Resource_typeof();
    ::TYPES[115] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[38] = ::g::Fuse::IViewport_typeof();
    ::TYPES[116] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[117] = ::g::Uno::UInt_typeof();
    ...
    ::TYPES[120] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[121] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[122] = ::g::Fuse::NodeBounds_typeof();
    ::TYPES[123] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ...
    ::TYPES[128] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Style_typeof());
    ::TYPES[129] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Style_typeof());
    ::TYPES[130] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Transform_typeof());
    type->SetInterfaces(
...
void Node::AddStyleTransform(::g::Fuse::Transform* t)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Transforms()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[92/*Fuse.Transform*/])), t);
}
...
{
    BeginRemove1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(BeginRemove1, value), ::TYPES[109/*Fuse.BeginRemoveHandler*/]);
}
...
{
    BeginRemove1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(BeginRemove1, value), ::TYPES[109/*Fuse.BeginRemoveHandler*/]);
}
...
{
    if (_behaviors == NULL)
        _behaviors = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[112/*Uno.Collections.ObservableList<Fuse.Behavior>*/], uDelegate::New(::TYPES[120/*Uno.Action<Fuse.Behavior>*/], this, offsetof(Node_type, fp_OnBehaviorAdded)), uDelegate::New(::TYPES[120/*Uno.Action<Fuse.Behavior>*/], this, offsetof(Node_type, fp_OnBehaviorRemoved))));
...
{
    DataContextChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(DataContextChanged1, value), ::TYPES[111/*Fuse.DataContextChangedHandler*/]);
}
...
{
    DataContextChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(DataContextChanged1, value), ::TYPES[111/*Fuse.DataContextChangedHandler*/]);
}
...
uObject* Node::FindObjectByName(uString* name, uDelegate* acceptor)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Behaviors()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[91/*Fuse.Behavior*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Behavior* b = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[101/*Uno.Collections.IEnumerator<Fuse.Behavior>*/]), &ret12), ret12);
        uObject* hs = uAs<uObject*>(b, ::TYPES[102/*Fuse.Scripting.INameScope*/]);

        if (hs == NULL)
            continue;

        uObject* res = ::g::Fuse::Scripting::INameScope::FindObjectByName(uInterface(uPtr(hs), ::TYPES[102/*Fuse.Scripting.INameScope*/]), name, acceptor);
...
::g::Uno::Float4x4 Node::GetTransformTo(Node* other)
{
    bool ret14;
    bool ret15;
    ::g::Uno::Collections::HashSet* parents = (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[105/*Uno.Collections.HashSet<Fuse.Node>*/]);
    Node* q = this;
...
{
    uPtr(uCast<uDelegate*>(obj, ::TYPES[16/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[87/*Uno.EventArgs*/]));
}
...
bool Node::IsLocalFlat()
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Transforms()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[92/*Fuse.Transform*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::g::Uno::Collections::IEnumerator_typeof())); )
    {
        ::g::Fuse::Transform* t = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[123/*Uno.Collections.IEnumerator<Fuse.Transform>*/]), &ret30), ret30);
        v = v && uPtr(t)->IsFlat();
    }
...
{
    uPtr(Properties())->Set(Node::_layerProperty(), uBox<int>(::TYPES[124/*Fuse.Layer*/], value));
    InvalidateLayout(2);
}
...
{
    uPtr(Properties())->Set(Node::_layoutRoleProperty(), uBox<int>(::TYPES[125/*Fuse.LayoutRole*/], value));
    InvalidateLayout(2);
}
...
void Node::MarkRooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[53/*"Rooting hap...*/], this, ::STRINGS[4/*"/usr/local/...*/], 4145, ::STRINGS[54/*"MarkRooted"*/]);
...
void Node::MarkUnrooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[55/*"Unrooting h...*/], this, ::STRINGS[4/*"/usr/local/...*/], 4202, ::STRINGS[56/*"MarkUnrooted"*/]);
...
{
    uPtr(t)->Added(this);
    t->add_MatrixChanged(uDelegate::New(::TYPES[115/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
{
    uPtr(t)->Removed(this);
    t->remove_MatrixChanged(uDelegate::New(::TYPES[115/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
...
float Node::PointDensity()
{
    ...
    return ::g::Fuse::IViewport::PointDensity(uInterface(uPtr(w), ::TYPES[38/*Fuse.IViewport*/]));
}
...
{
    if (HasBit(ne))
        uPtr(Properties())->ForeachInList1(ph, uDelegate::New(::TYPES[116/*Uno.Action<object, object>*/], (void*)Node__InvokeEventHandler_fn, this), ::g::Uno::EventArgs::Empty());
}
...
{
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RequestBringIntoView1, value), ::TYPES[110/*Fuse.RequestBringIntoViewHandler*/]);
}
...
{
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RequestBringIntoView1, value), ::TYPES[110/*Fuse.RequestBringIntoViewHandler*/]);
}
...
uObject* Node::Resources()
{
    ...
    {
        SetBit(1);
        uPtr(Properties())->Set(Node::_resourcesHandle(), (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[126/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[127/*Uno.Action<Uno.UX.Resource>*/], (void*)Node__OnResourceChanged_fn, this), uDelegate::New(::TYPES[127/*Uno.Action<Uno.UX.Resource>*/], (void*)Node__OnResourceChanged_fn, this)));
    }
...
void Node::SetResource(uString* key, uObject* value)
{
    ...
    {
        ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[119/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret22), ret22);
...
uObject* Node::Styles()
{
    ...
    if (!uPtr(Properties())->TryGet(Node::_styleHandle(), &listobj))
    {
        listobj = (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[128/*Uno.Collections.ObservableList<Fuse.Style>*/], uDelegate::New(::TYPES[129/*Uno.Action<Fuse.Style>*/], (void*)Node__StyleAdded_fn, this), uDelegate::New(::TYPES[129/*Uno.Action<Fuse.Style>*/], (void*)Node__StyleRemoved_fn, this));
...
{
    if (_transforms == NULL)
        _transforms = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[113/*Uno.Collections.ObservableList<Fuse.Transform>*/], uDelegate::New(::TYPES[115/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnTransformAdded_fn, this), uDelegate::New(::TYPES[115/*Uno.Action<Fuse.Transform>*/], (void*)Node__OnTransformRemoved_fn, this)));
...
bool Node::TryGetResource(uString* key, uDelegate* acceptor, uObject** resource)
{
    ...
    if (HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[118/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[119/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret23), ret23);
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2320)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(4285)
// ---------------------------------------------------------
...
uType* NodeBounds_typeof()
{
    ...
    ::TYPES[107] = ::g::Uno::Float3_typeof();
    ::TYPES[131] = ::g::Uno::Geometry::Box_typeof();
    ::TYPES[73] = ::g::Uno::Float2_typeof();
    ::TYPES[96] = ::g::Fuse::FastMatrix_typeof();
    ::TYPES[7] = ::g::Uno::Bool_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(872)
// --------------------------------------------------------
...
NodeEvent_type* NodeEvent_typeof()
{
    ...
    ::STRINGS[60] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno");
    ::TYPES[132] = ::g::Uno::Collections::List_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[20] = uObject_typeof();
    ::TYPES[133] = ::g::Fuse::NodeEventArgs_typeof();
    ::TYPES[134] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array());
    ::TYPES[7] = ::g::Uno::Bool_typeof();
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[135] = uObject_typeof()->Array();
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    ::TYPES[136] = ::g::Uno::Action2_typeof();
    ::TYPES[137] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetPrecalc(
        ::TYPES[132/*Uno.Collections.List`1*/]->MakeType(type->T(0)),
        ::TYPES[136/*Uno.Action`2*/]->MakeType(type->T(1), ::TYPES[137/*Uno.Collections.IList<Fuse.Node>*/]));
    type->SetFields(0,
...
void NodeEvent::Raise(::g::Fuse::NodeEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[134/*Uno.Action<object, object[]>*/], (void*)NodeEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[134/*Uno.Action<object, object[]>*/], (void*)NodeEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[60/*"Invalid Rai...*/], 1, ::STRINGS[4/*"/usr/local/...*/], 934);
            return;
        }
    }
    ...
    for (int i = 0; i < uPtr(list)->Count(); ++i)
        uPtr(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret2), ret2))->Properties())->ForeachInList(_handle, handler, uArray::Init<uObject*>(::TYPES[135/*object[]*/], 2, (::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret3), ret3), args));
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(978)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(999)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(837)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(850)
// --------------------------------------------------------
...
{
    NodeListCache::_nodeListCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[138/*Uno.Collections.List<Uno.Collections.List<Fuse.Node>>*/]));
}
...
uClassType* NodeListCache_typeof()
{
    ...
    ::TYPES[138] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof()));
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(4517)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6348)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(4629)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6276)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6301)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5058)
// ---------------------------------------------------------
...
uType* Properties_typeof()
{
    ...
    ::TYPES[116] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[135] = uObject_typeof()->Array();
    ::TYPES[139] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    type->SetFields(0,
...
{
    if (_handle == NULL)
        return uArray::New(::TYPES[135/*object[]*/], 0);

    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[139/*Uno.Collections.List<object>*/]);
    Properties* p = this;
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5053)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(3188)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(462)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2812)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2821)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(3873)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(4120)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(232)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(1747)
// ---------------------------------------------------------
...
RootViewport_type* RootViewport_typeof()
{
    ...
    ::STRINGS[61] = uString::Const("A Window cannot have zero density.");
    ::TYPES[140] = ::g::Fuse::IFrustum_typeof();
    ::TYPES[77] = ::g::Uno::Platform::Window_typeof();
    ::TYPES[16] = ::g::Uno::EventHandler_typeof();
    ::TYPES[38] = ::g::Fuse::IViewport_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
...
{
    return ::g::Fuse::IFrustum::GetWorldPosition(uInterface(uPtr(Frustum), ::TYPES[140/*Fuse.IFrustum*/]), (uObject*)this);
}
...
{
    return ::g::Fuse::IFrustum::GetDepthRange(uInterface(uPtr(Frustum), ::TYPES[140/*Fuse.IFrustum*/]), (uObject*)this);
}
...
float RootViewport::DefaultDensity()
{
    ...
    if (RootViewport::_defaultDensity() < 0.0f)
    {
        ...
        if (RootViewport::_defaultDensity() == 0.0f)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[61/*"A Window ca...*/]));
    }
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6089)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5271)
// ---------------------------------------------------------
...
::g::Fuse::Transform_type* Scaling_typeof()
{
    ...
    ::TYPES[141] = ::g::Fuse::ScalingModes_typeof();
    ::TYPES[7] = ::g::Uno::Bool_typeof();
    ::TYPES[107] = ::g::Uno::Float3_typeof();
    type->SetFields(4,
...
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr(_relativeTo), ::TYPES[142/*Fuse.IScalingMode*/]), this);
}
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5260)
// ---------------------------------------------------------
...
uClassType* ScalingModes_typeof()
{
    ...
    ::TYPES[142] = ::g::Fuse::IScalingMode_typeof();
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6195)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(2773)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6342)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6600)
// ---------------------------------------------------------
...
uType* Stage_typeof()
{
    ...
    ::TYPES[143] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof());
    ::TYPES[144] = ::g::Fuse::UpdateListener_typeof();
    type->SetFields(0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[143/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[143/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[143/*Uno.Collections.List<Fuse.UpdateListener>*/]));
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5753)
// ---------------------------------------------------------
...
Style_type* Style_typeof()
{
    ...
    ::TYPES[145] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    ::TYPES[7] = ::g::Uno::Bool_typeof();
    ::TYPES[146] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    ::TYPES[114] = ::g::Uno::UX::Resource_typeof();
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    ::TYPES[68] = ::g::Uno::Action_typeof();
    ::TYPES[118] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[119] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[100] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof());
    ::TYPES[147] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(Style_typeof());
    ::TYPES[126] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[127] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[94] = ::g::Uno::Collections::IList_typeof()->MakeType(Style_typeof());
    ::TYPES[148] = ::g::Uno::Collections::List_typeof()->MakeType(Style_typeof());
    ::TYPES[149] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    ::TYPES[150] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::ITemplate_typeof());
    type->SetInterfaces(
...
bool Style::Apply(uObject* target)
{
    ...
    if (_templates != NULL)
        ...
        for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_templates), ::TYPES[145/*Uno.Collections.ICollection<Uno.UX.ITemplate>*/])); (i--) > 0; )
            if (!::g::Uno::UX::ITemplate::Apply(uInterface(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_templates), ::TYPES[146/*Uno.Collections.IList<Uno.UX.ITemplate>*/]), uCRef<int>(i), &ret5), ret5)), ::g::Uno::UX::ITemplate_typeof()), target))
                return false;
...
{
    return (_resources != NULL) && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_resources), ::TYPES[118/*Uno.Collections.ICollection<Uno.UX.Resource>*/])) > 0);
}
...
{
    if (_resources == NULL)
        _resources = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[126/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[127/*Uno.Action<Uno.UX.Resource>*/], (void*)Style__OnResourceChanged_fn, this), uDelegate::New(::TYPES[127/*Uno.Action<Uno.UX.Resource>*/], (void*)Style__OnResourceChanged_fn, this)));
...
uObject* Style::Styles()
{
    ...
    return (ind3 != NULL) ? ind3 : (uObject*)(_styles = (uObject*)((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[148/*Uno.Collections.List<Fuse.Style>*/])));
}
...
uObject* Style::Templates()
{
    ...
    return (ind2 != NULL) ? ind2 : (uObject*)(_templates = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[149/*Uno.Collections.ObservableList<Uno.UX.ITemplate>*/], uDelegate::New(::TYPES[150/*Uno.Action<Uno.UX.ITemplate>*/], (void*)Style__OnTemplateAdded_fn, this), uDelegate::New(::TYPES[150/*Uno.Action<Uno.UX.ITemplate>*/], (void*)Style__OnTemplateRemoved_fn, this))));
}
...
bool Style::TryGetResource(uString* key, uDelegate* acceptor, uObject** resource)
{
    ...
    if (HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[118/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[119/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret7), ret7);
    ...
    if (_styles != NULL)
        ...
        {
            Style* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[147/*Uno.Collections.IEnumerator<Fuse.Style>*/]), &ret9), ret9);
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5409)
// ---------------------------------------------------------
...
StyleProperty_type* StyleProperty_typeof()
{
    ...
    ::TYPES[151] = ::g::Uno::Collections::List_typeof()->MakeType(StyleProperty_typeof());
    type->SetFields(0,
...
void StyleProperty::ctor_()
{
    if (StyleProperty::All() == NULL)
        StyleProperty::All() = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[151/*Uno.Collections.List<Fuse.StyleProperty>*/]));
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5445)
// ---------------------------------------------------------
...
::g::Fuse::StyleProperty_type* StyleProperty1_typeof()
{
    ...
    ::TYPES[152] = ::g::Fuse::StyleProperty_typeof();
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[20] = uObject_typeof();
    ::TYPES[153] = ::g::Uno::Func1_typeof();
    ::TYPES[28] = ::g::Uno::Int_typeof();
    ::TYPES[154] = ::g::Uno::Action1_typeof();
    ::TYPES[136] = ::g::Uno::Action2_typeof();
    ::TYPES[7] = ::g::Uno::Bool_typeof();
    type->SetPrecalc(
        ::TYPES[153/*Uno.Func`2*/]->MakeType(type->T(0), type->T(1)),
        ::TYPES[154/*Uno.Action`1*/]->MakeType(type->T(0)),
        ::TYPES[136/*Uno.Action`2*/]->MakeType(type->T(0), type->T(1)));
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5633)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5869)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5999)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(5943)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6032)
// ---------------------------------------------------------
...
Transform_type* Transform_typeof()
{
    ...
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    ::TYPES[115] = ::g::Uno::Action1_typeof()->MakeType(Transform_typeof());
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6311)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6373)
// ---------------------------------------------------------
...
::g::Fuse::Transform_type* Translation_typeof()
{
    ...
    ::TYPES[155] = ::g::Fuse::TranslationModes_typeof();
    ::TYPES[107] = ::g::Uno::Float3_typeof();
    ::TYPES[92] = ::g::Fuse::Transform_typeof();
    ::TYPES[156] = ::g::Fuse::ITransformMode_typeof();
    ::TYPES[28] = ::g::Uno::Int_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[157] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[158] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[16] = ::g::Uno::EventHandler_typeof();
    ::TYPES[73] = ::g::Uno::Float2_typeof();
    type->SetFields(4,
...
{
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr(__this->RelativeTo()), ::TYPES[159/*Fuse.ITranslationMode*/]), __this), weight_);
...
{
    ::g::Uno::Float3 v = ::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr(__this->RelativeTo()), ::TYPES[159/*Fuse.ITranslationMode*/]), __this);
...
void Translation::CheckSubscription()
{
    ...
    int flags = ::g::Fuse::ITransformMode::Flags(uInterface(uPtr(RelativeTo()), ::TYPES[156/*Fuse.ITransformMode*/]));
    ...
    uObject* act = uAs<uObject*>(node, ::TYPES[157/*Fuse.IActualPlacement*/]);

    if (_subscribed != act)
    {
        if (_subscribed != NULL)
        {
            ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(_subscribed), ::TYPES[157/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[158/*Fuse.PlacedHandler*/], (void*)Translation__OnPlaced_fn, this));
            _subscribed = NULL;
        }

        if (act != NULL)
        {
            ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(act), ::TYPES[157/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[158/*Fuse.PlacedHandler*/], (void*)Translation__OnPlaced_fn, this));
            _subscribed = act;
        }
    }
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6334)
// ---------------------------------------------------------
...
uClassType* TranslationModes_typeof()
{
    ...
    ::TYPES[159] = ::g::Fuse::ITranslationMode_typeof();
    ::TYPES[157] = ::g::Fuse::IActualPlacement_typeof();
    type->SetFields(0,
...
::g::Uno::Float3 TranslationModes::RelativeToSize(::g::Uno::Float3 v, ::g::Fuse::Node* node)
{
    ...
    uObject* isz = uAs<uObject*>(node, ::TYPES[157/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return v;

    return ::g::Uno::Float3__op_Multiply2(v, ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[157/*Fuse.IActualPlacement*/])));
}
// }

// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(15)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(26)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6631)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6582)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6639)
// ---------------------------------------------------------
...
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[160/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[161/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[161/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_phaseDeferredActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[161/*Uno.Collections.List<Uno.Action>*/]));
...
uClassType* UpdateManager_typeof()
{
    ...
    ::TYPES[160] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof());
    ::TYPES[161] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[162] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[163] = ::g::Fuse::UpdateStage_typeof();
    ::TYPES[144] = ::g::Fuse::UpdateListener_typeof();
    ::TYPES[28] = ::g::Uno::Int_typeof();
    ::TYPES[164] = ::g::Fuse::Stage_typeof();
    ::TYPES[68] = ::g::Uno::Action_typeof();
    ::TYPES[165] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[7] = ::g::Uno::Bool_typeof();
    ::TYPES[143] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof());
    ::TYPES[20] = uObject_typeof();
    type->SetFields(0,
    ...
    while (true)
    {
        ...
        for (int i = 0; i < uPtr(a)->Count(); ++i)
            ...
            catch (const uThrowable& __t)
            {
                ...
                if (_exceptions == NULL)
                    _exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[165/*Uno.Collections.List<Uno.Exception>*/]);
...
// /usr/local/share/uno/Packages/FuseCore/0.18.8/$.uno(6569)
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/0.18.8/$.uno(255)
// ---------------------------------------------------------------
...
::g::Fuse::Behavior_type* UserEvent_typeof()
{
    ...
    ::STRINGS[65] = uString::Const("Unknown event: ");
    ::STRINGS[66] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.18.8/$.uno");
    ::STRINGS[67] = uString::Const("RaiseEvent");
    ::TYPES[91] = ::g::Fuse::Behavior_typeof();
    ::TYPES[3] = ::g::Fuse::Node_typeof();
    ::TYPES[101] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Behavior_typeof());
    ::TYPES[166] = ::g::Fuse::UserEventHandler_typeof();
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    type->SetFields(3,
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Raised1, value), ::TYPES[166/*Fuse.UserEventHandler*/]);
}

// public generated void remove_Raised(Fuse.UserEventHandler value) [instance] :257
void UserEvent::remove_Raised(uDelegate* value)
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Raised1, value), ::TYPES[166/*Fuse.UserEventHandler*/]);
}
...
void UserEvent::RaiseEvent(::g::Fuse::Node* from, uString* name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::Error(::g::Uno::String::op_Addition2(::STRINGS[65/*"Unknown eve...*/], name), NULL, ::STRINGS[66/*"/usr/local/...*/], 306, ::STRINGS[67/*"RaiseEvent"*/]);
        return;
    }
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, uString* name, ::g::Fuse::Node** node)
{
    ...
    while (at != NULL)
    {
        ...
        {
            ::g::Fuse::Behavior* b = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[101/*Uno.Collections.IEnumerator<Fuse.Behavior>*/]), &ret3), ret3);
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/0.18.8/$.uno(176)
// ---------------------------------------------------------------
...
UserEventArgs_type* UserEventArgs_typeof()
{
    ...
    ::TYPES[167] = ::g::Fuse::UserEventDispatch_typeof();
    ::TYPES[168] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[169] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    type->SetInterfaces(
...
void UserEventArgs__Fuse_Scripting_IScriptEvent_Serialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::g::Fuse::Scripting::IEventSerializer_typeof()), ::STRINGS[68/*"name"*/], uPtr(__this->Dispatch())->Name());

    if (__this->Args() != NULL)

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->Args()), &ret3), ret3); enum1.MoveNext(::TYPES[168/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > m = enum1.Current(::TYPES[168/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
            ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::g::Fuse::Scripting::IEventSerializer_typeof()), m.Key(::TYPES[169/*Uno.Collections.KeyValuePair<string, object>*/]), m.Value(::TYPES[169/*Uno.Collections.KeyValuePair<string, object>*/]));
        }
}
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/0.18.8/$.uno(215)
// ---------------------------------------------------------------
...
{
    UserEventDispatch::_userEvents_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[170/*Uno.Collections.Dictionary<string, Fuse.UserEventDispatch>*/]));
}
...
uType* UserEventDispatch_typeof()
{
    ...
    ::TYPES[170] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), UserEventDispatch_typeof());
    ::TYPES[22] = ::g::Uno::Delegate_typeof();
    ::TYPES[166] = ::g::Fuse::UserEventHandler_typeof();
    ::TYPES[20] = uObject_typeof();
    ::TYPES[68] = ::g::Uno::Action_typeof();
...
{
    ::g::Fuse::UserEventArgs* m = ::g::Fuse::UserEventArgs::New2(this, source, args);
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[68/*Uno.Action*/], (void*)::g::Fuse::UserEventArgs__Raise_fn, m));
}
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/0.18.8/$.uno(213)
// ---------------------------------------------------------------
