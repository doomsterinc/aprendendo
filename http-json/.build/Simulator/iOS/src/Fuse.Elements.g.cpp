...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1898)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1923)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1680)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1685)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(11)
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(18)
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1320)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(11)
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(266)
// ---------------------------------------------------------------------
...
void CacheHelper::Blit(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Cache* cache, float opacity)
{
    ...
    for (array1 = uPtr(cache)->CacheTiles(), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        _draw_934926a0.Uniform12(3, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[23/*Fuse.IViewport*/])));
...
{
    uArray* Vertices_934926a0_1_0_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[24/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f));
    ...
    _draw_934926a0 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Elements_bundle::CacheHelper09c90965());
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(101)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1975)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1675)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(395)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(439)
// -------------------------------------------------------------
...
Element_type* Element_typeof()
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsLocalRooted())
        ::g::Fuse::Diagnostics::Error(::STRINGS[3/*"Draw called...*/], __this, ::STRINGS[2/*"/usr/local/...*/], 617, ::STRINGS[4/*"Draw"*/]);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[0/*"CaptureRegi...*/], uBox(::TYPES[8/*int2*/], fsz)), ::STRINGS[1/*", max-size: "*/]), uBox<int>(::TYPES[0/*int*/], ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[2/*"/usr/local/...*/], 593);
        return NULL;
    }
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(607)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(315)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(419)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(373)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(491)
// ---------------------------------------------------------------------
...
// private extern void DiscardPool() :526
...
// private extern void DiscardPool() [instance] :526
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(1190)
// ----------------------------------------------------------------------
...
{
    _draw_3bd224e1 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Elements_bundle::ElementBatch47d0cb7a());
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(1125)
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(830)
// ---------------------------------------------------------------------
...
ElementBatcher_type* ElementBatcher_typeof()
{
    ...
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno");
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Node*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret25), ret25); enum4.MoveNext(::TYPES[94/*Uno.Collections.List<Fuse.Node>.Enumerator*/]); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[13/*"BUG: atlas-...*/], 1, ::STRINGS[14/*"/usr/local/...*/], 1027);
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1304)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(887)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(811)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1663)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2027)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2066)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2020)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2206)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(423)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2315)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2345)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1205)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1216)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1968)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(816)
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2367)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1982)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(107)
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2000)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1989)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2007)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1884)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Caching/$.uno(1460)
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1878)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1670)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2349)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1668)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(2313)
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.18.8/$.uno(4522)
// --------------------------------------------------------------
...
void Viewport__OnDraw_fn(Viewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->Flatten())
    {
        ...
        __this->_draw_79d7a860.Uniform12(1, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[23/*Fuse.IViewport*/])));
...
{
    OnDraw_VertexData_79d7a860_7_2_1 = ::g::Uno::Graphics::VertexBuffer::New2(::g::Uno::Runtime::Implementation::Internal::BufferConverters::ToBuffer3(uArray::Init< ::g::Uno::Float2>(::TYPES[24/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f))), 0);
    ...
    _draw_79d7a860 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Controls_bundle::Viewportb83477c3());
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/$.uno(1891)
// --------------------------------------------------------------
