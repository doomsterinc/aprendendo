...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Drawing/$.uno(179)
// ---------------------------------------------------------------------
...
uType* ElementDraw_typeof()
{
    ...
    ::TYPES[3] = ::g::Fuse_Controls_bundle_typeof();
...
void ElementDraw::init_DrawCalls()
{
    ...
    _draw_b1f11b73 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Controls_bundle::SolidRectangleafb52826());
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.18.8/Drawing/$.uno(203)
// ---------------------------------------------------------------------
...
uType* Scale9Rectangle_typeof()
{
    ...
    ::TYPES[11] = ::g::Fuse_Elements_bundle_typeof();
    type->SetFields(0,
...
void Scale9Rectangle::init_DrawCalls()
{
    ...
    _draw_d7134d74 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Elements_bundle::Scale9Rectangle3a507581());
}
